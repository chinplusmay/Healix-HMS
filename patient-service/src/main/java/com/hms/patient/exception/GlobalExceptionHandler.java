...
import com.hms.patient.dto.ApiError;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Triggered when JSON deserialization fails — for example, an unknown enum value
     * for `gender` or `bloodGroup`. Translated to a 400 with the underlying cause's message.
     */
    ...
    /**
     * Triggered when a path/query variable cannot be coerced (e.g. /patients/abc).
     */
